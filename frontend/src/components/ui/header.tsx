...
export function Header1({ children }: { children?: ReactNode }) {
  ...
  return <header className="product-header">
    <Link href="/" className="product-brand" title="PRAETOR AI home"><span className="product-monogram" aria-hidden="true">P<span>·</span></span><span>PRAETOR<span className="product-brand-ai"> AI</span><small>INDIAN LAW. IN CONTEXT.</small></span></Link>
